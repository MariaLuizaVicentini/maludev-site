        ...
        <div class="container">
            <div class="row align-items-center">
                ...
                <div class="col-lg-5 text-center mt-5 mt-lg-0">
                    <div style="width: 320px; height: 320px; border-radius: 50%; border: 3px solid #00e676; margin: 0 auto; display: flex; align-items: center; justify-content: center; background: linear-gradient(135deg, #111, #1a1a1a); overflow: hidden; box-shadow: 0 0 20px rgba(0, 230, 118, 0.2);">
                        <img src="{{ asset('img/logo-inicio.jpg') }}" alt="Logo Malu" style="width: 100%; height: 100%; object-fit: cover;">
                    </div>
                </div>
            </div>
        </div>
